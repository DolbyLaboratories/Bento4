                                      ...
                                      AP4_Atom*&      atom)
{
    ...
    if (GetContext() == AP4_ATOM_TYPE_STSD) {
        ...
        switch (type) {
          ...
          case AP4_ATOM_TYPE_PRES:
            if (atom_is_large) return AP4_ERROR_INVALID_FORMAT;
            atom = AP4_PresAtom::Create(size_32, stream, *this);
            break;

          case AP4_ATOM_TYPE_PRSE:
            if (atom_is_large) return AP4_ERROR_INVALID_FORMAT;
            atom = AP4_PrseAtom::Create(size_32, stream, *this);
            break;

          case AP4_ATOM_TYPE_PRSP:
            if (atom_is_large) return AP4_ERROR_INVALID_FORMAT;
            atom = AP4_PrspAtom::Create(size_32, stream);
            break;
