...
const AP4_Atom::Type AP4_ATOM_TYPE_PRES = AP4_ATOM_TYPE('p','r','e','s');
const AP4_Atom::Type AP4_ATOM_TYPE_PRSE = AP4_ATOM_TYPE('p','r','s','e');
const AP4_Atom::Type AP4_ATOM_TYPE_PRSP = AP4_ATOM_TYPE('p','r','s','p');
