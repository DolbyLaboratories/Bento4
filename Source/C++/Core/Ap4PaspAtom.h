...
public:
    ...
    // constructors
    AP4_PaspAtom();
    AP4_PaspAtom(AP4_UI32 hSpacing,
                 AP4_UI32 vSpacing);
    AP4_PaspAtom(AP4_UI32 size, const AP4_UI08* payload);
    ...
    // accessors
    AP4_UI32 GetHSpacing()                { return m_hSpacing; }
    AP4_UI32 GetVSpacing()                { return m_vSpacing; }
